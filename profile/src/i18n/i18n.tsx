...
const translations: Record<Lang, Translations> = {
  pt: {
    ...
    "services.hero.title": "Execução Web Confiável para Agências e Equipes de Marketing",
    "services.hero.subtitle": "Construo sites de alta conversão e aplicações escaláveis para que você foque na estratégia, design e fechamento de vendas.",
    "services.hero.cta": "Iniciar um Projeto",

    "services.problems.title": "Gargalos Técnicos que Elimino para Agências",
    "services.problems.p1": "Prazos perdidos que frustram seus clientes",
    "services.problems.p2": "Sites \"prontos\" cheios de bugs e lentos",
    "services.problems.p3": "Desenvolvedores que somem ou se comunicam mal",
    "services.problems.p4": "Aumento de escopo por falta de planejamento técnico",
    "services.problems.p5": "Sites lentos que prejudicam o ROI das suas campanhas",

    "services.agency.badge": "Parcerias com Agências",
    "services.agency.title": "Procurando um Parceiro de Desenvolvimento Confiável?",
    "services.agency.desc": "Atuo como um braço técnico de alta performance para agências. Ofereço desenvolvimento 100% white-label, compatível com NDA, com foco em qualidade e velocidade.",
    ...
    "services.list.landing": "Landing Pages de Alta Performance",
    "services.list.landing.desc": "Landing pages ultrarrápidas otimizadas para maximizar o ROI do seu investimento em tráfego.",
    "services.list.landing.f1": "Carregamento ultrarrápido",
    "services.list.landing.f2": "Experiência mobile impecável",
    "services.list.landing.f3": "ROI em anúncios maximizado",
    "services.list.landing.f4": "Implementação pixel-perfect",
    "services.list.landing.cta": "Iniciar um Projeto",

    "services.list.business": "Sites Corporativos White-Label",
    "services.list.business.desc": "Sites de negócio escaláveis construídos sob a marca da sua agência. Entregue experiências web premium sem os custos de uma equipe interna.",
    "services.list.business.f1": "Mantenha suas margens",
    "services.list.business.f2": "Sem custos de dev interno",
    "services.list.business.f3": "Arquitetura de alta performance",
    "services.list.business.f4": "Fácil para clientes editarem",
    "services.list.business.cta": "Iniciar um Projeto",

    "services.list.saas": "Aplicações Web Sob Medida",
    "services.list.saas.desc": "Ferramentas personalizadas, portais de clientes e soluções SaaS. Resolvendo requisitos complexos quando ferramentas prontas falham.",
    "services.list.saas.f1": "Lógica e fluxos complexos",
    "services.list.saas.f2": "Integrações personalizadas com APIs",
    "services.list.saas.f3": "Arquitetura segura e escalável",
    "services.list.saas.f4": "Construído sob medida",
    "services.list.saas.cta": "Iniciar um Projeto",

    "services.list.maintenance": "Manutenção Contínua",
    "services.list.maintenance.desc": "Mantendo os sites dos seus clientes rápidos, seguros e livres de bugs pós-lançamento. Suporte previsível no qual você pode confiar.",
    "services.list.maintenance.f1": "Atualizações de segurança proativas",
    "services.list.maintenance.f2": "Resolução rápida de bugs",
    "services.list.maintenance.f3": "Monitoramento de performance",
    "services.list.maintenance.f4": "SLA Confiável",
