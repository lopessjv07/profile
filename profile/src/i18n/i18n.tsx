...
const translations: Record<Lang, Translations> = {
  pt: {
    ...
    "contact.hero.subtitle": "Tem um projeto em mente ou precisa de um site de alta performance? Fique à vontade para entrar em contato.",
    "contact.hero.desc": "Ajudo empresas a construir experiências web rápidas, escaláveis e modernas usando tecnologias como Next.js, React e arquitetura web moderna.",

    "contact.methods.title": "Formas de Contato",
    "contact.email.title": "Email",
    "contact.email.value": "hello@lopessdev.com",
    "contact.email.desc": "Melhor forma de me contatar para consultas de projetos.",
    ...
    "contact.whatsapp.desc": "Comunicação rápida para discussões de projetos.",
    "contact.whatsapp.btn": "Enviar Mensagem",
    "contact.discord.title": "Discord",
    "contact.discord.desc": "Disponível para conversas rápidas se necessário.",
    "contact.discord.btn": "Conversar",
    ...
    "contact.form.note": "Normalmente respondo em até 24 horas.",

    "contact.cta.title": "Pronto para iniciar seu projeto?",
    "contact.cta.subtitle": "Se você precisa de um site rápido, moderno e escalável, vamos conversar.",
    "contact.cta.btn": "Enviar uma mensagem",
  ...
  en: {
    ...
    "contact.hero.subtitle": "Have a project in mind or need a high-performance website? Feel free to reach out.",
    "contact.hero.desc": "I help businesses build fast, scalable and modern web experiences using technologies like Next.js, React and modern web architecture.",

    "contact.methods.title": "Contact Methods",
    "contact.email.title": "Email",
    "contact.email.value": "hello@lopessdev.com",
    "contact.email.desc": "Best way to reach me for project inquiries.",
    "contact.email.btn": "Send Email",
    "contact.linkedin.title": "LinkedIn",
    "contact.linkedin.desc": "Connect with me professionally.",
    "contact.linkedin.btn": "Connect",
    "contact.whatsapp.title": "WhatsApp",
    "contact.whatsapp.desc": "Quick communication for project discussions.",
    "contact.whatsapp.btn": "Message",
    "contact.discord.title": "Discord",
    "contact.discord.desc": "Available for quick chats if needed.",
    "contact.discord.btn": "Chat",
    ...
    "contact.cta.subtitle": "If you need a fast, modern and scalable website, let's talk.",
    "contact.cta.btn": "Send a message",
